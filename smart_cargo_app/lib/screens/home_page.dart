...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> resetLoad() async {
    ...
    setState(() {
      controller.stops.clear();
      controller.lastStop = null;
    });
  }

  @override
  Widget build(BuildContext context) {
    final currentStop = controller.lastStop;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  InfoCard(title: 'Pacotes', value: controller.totalPackages),
                  const SizedBox(width: 8),
                  InfoCard(title: 'Paradas', value: controller.stops.length),
                ],
              ),
              ...
              Row(
                children: [
                  InfoCard(
                    title: 'Condomínios',
                    value: controller.condominiums,
                    compact: true,
                  ),
                  const SizedBox(width: 8),
                  InfoCard(
                    title: 'Residências',
                    value: controller.residences,
                    compact: true,
                  ),
                  const SizedBox(width: 8),
                  InfoCard(
                    title: 'Comércios',
                    value: controller.commerces,
                    compact: true,
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    controller.knownLocationsCount == 1
                        ? '1 local na memória'
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: controller.processing ? null : openScanner,
              ...
              SizedBox(
                ...
                height: 56,
                child: OutlinedButton.icon(
                  onPressed: controller.processing ? null : openManualEntry,
              ...
              SizedBox(
                ...
                height: 52,
                child: OutlinedButton.icon(
                  onPressed: controller.stops.isEmpty || controller.processing
                      ? null
                      : resetLoad,
...
class _ManualEntryPageState extends State<ManualEntryPage> {
  ...
  void initState() {
    ...
    streetController = TextEditingController(text: widget.initialStreet.trim());
